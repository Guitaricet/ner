...
# python3 noise_experiment.py --ataset data/collection5 --embeddings-format word2vec --embeddings /media/data/nlp/data/GoogleNews-vectors-negative300.bin  --no-char-embeddings --results-filename results/collection5_word2vec_fixed_nochar.csv
