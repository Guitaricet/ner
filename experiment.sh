...
python3 noise_experiment.py --dataset conll2003 --no-char-embeddings --results-filename conll_noembed_nochar_gru.csv
python3 noise_experiment.py --dataset conll2003 --no-char-embeddings --results-filename --embeddings /media/data/nlp/data/wiki.en.bin conll_fasttext_nochar_gru.csv
