...
echo -e "\nFactRU\n"
python3 noise_experiment.py --epochs 40 --dataset data/factru --results-filename results/factru_noembed_40epochs.csv
python3 noise_experiment.py --epochs 40 --dataset data/factru --embeddings /media/data/nlp/data/wiki.ru.bin --results-filename results/factru_fasttext_40epochs.csv
python3 noise_experiment.py --epochs 40 --dataset data/factru --no-char-embeddings --results-filename results/factru_noembed_nochar_40epochs.csv
python3 noise_experiment.py --epochs 40 --dataset data/factru --no-char-embeddings --embeddings /media/data/nlp/data/wiki.ru.bin --results-filename results/factru_fasttext_nochar_40epochs.csv
