...
python3 noise_experiment.py --dataset collection5 --embeddings /media/data/nlp/data/wiki.ru.bin --results-filename collection5_fasttext_nochar.csv
python3 noise_experiment.py --dataset collection5 --no-char-embeddings --results-filename collection5_noembed_nochar.csv
python3 noise_experiment.py --dataset collection5 --no-char-embeddings --results-filename --embeddings /media/data/nlp/data/wiki.ru.bin collection5_fasttext_nochar.csv
