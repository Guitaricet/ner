...
python3 noise_experiment.py --dataset data/conll2003 --embeddings /data/embeddings/wiki.en.bin --results-filename results/conll2003_fasttext.csv
...
python3 noise_experiment.py --dataset data/conll2003 --no-char-embeddings --embeddings /data/embeddings/wiki.en.bin --results-filename results/conll2003_fasttext_nochar.csv
